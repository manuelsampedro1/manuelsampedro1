...
- Continue publishing follow-up lab notes or recipes directly from flagship repo changes; `briefboard-local`, `agent-run-ledger`, `repo-flightcheck`, `verify-by-change`, `codex-review-packet`, and `profile-proof-audit` now have behavior-changing follow-ups with public evidence.
