...
| I keep structured agent outputs safe for automation. | [`agent-output-contract`](https://github.com/manuelsampedro1/agent-output-contract), [`agent-tool-call-replay`](https://github.com/manuelsampedro1/agent-tool-call-replay), [`agent-run-ledger`](https://github.com/manuelsampedro1/agent-run-ledger) | JSON outcome contracts, schema-version checks, blocker consistency, tool-call replay, and ledger import boundaries. |
