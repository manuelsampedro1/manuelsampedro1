...
| I keep structured agent outputs and evidence chains safe for automation. | [`agent-output-contract`](https://github.com/manuelsampedro1/agent-output-contract), [`agent-evidence-chain`](https://github.com/manuelsampedro1/agent-evidence-chain), [`agent-tool-call-replay`](https://github.com/manuelsampedro1/agent-tool-call-replay), [`agent-run-ledger`](https://github.com/manuelsampedro1/agent-run-ledger) | JSON outcome contracts, schema-version checks, blocker consistency, shared task/repo/commit identity, tool-call replay, and ledger import boundaries. |
| I keep agent-written claims grounded before public reuse. | [`agent-source-grounding`](https://github.com/manuelsampedro1/agent-source-grounding), [`agent-claim-check`](https://github.com/manuelsampedro1/agent-claim-check), [`profile-proof-audit`](https://github.com/manuelsampedro1/profile-proof-audit) | Markdown/JSON source sections, claim-table grounding, placeholder citations, optional HTTP checks, closeout claim evidence, and profile link audits. |
