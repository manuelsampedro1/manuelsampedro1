...
- Repo / tool / workflow: local `agent-change-risk` prototype at `/Users/manuelsampedro/Documents/Codex/2026-05-21/agent-change-risk`.
- Supporting prompt, script, or note: [`./scope-guard-for-agent-diffs.md`](./scope-guard-for-agent-diffs.md), [`./agent-diff-secret-sentinel.md`](./agent-diff-secret-sentinel.md), [`./rollback-plan-for-agent-diffs.md`](./rollback-plan-for-agent-diffs.md), and [`./closeout-evidence-check-for-agents.md`](./closeout-evidence-check-for-agents.md).
