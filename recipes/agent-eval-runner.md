...
- Repo / tool / workflow: local `agent-eval-runner` prototype at `/Users/manuelsampedro/Documents/Codex/2026-05-21/agent-eval-runner`.
- Supporting prompt, script, or note: [`./diff-to-eval-case.md`](./diff-to-eval-case.md), [`./agent-proof-packet-for-review.md`](./agent-proof-packet-for-review.md), and [`./change-risk-matrix-for-agent-diffs.md`](./change-risk-matrix-for-agent-diffs.md).
