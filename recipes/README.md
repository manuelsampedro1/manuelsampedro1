...
- [Stable Acceptance Criteria IDs](./stable-acceptance-criteria-ids.md)
...
- [Redacted Artifact Manifests](./redacted-artifact-manifests.md)
...
- [Proof Packet Backed Scope Guards](./proof-packet-backed-scope-guards.md)
...
- [Proof Packet Backed Diff Splits](./proof-packet-backed-diff-splits.md)
- [Proof Packet Backed Diff Budgets](./proof-packet-backed-diff-budgets.md)
...
- [Profile Evidence Map Link Gate](./profile-evidence-map-link-gate.md)
...
- [Hash-Backed Worktree Snapshots](./hash-backed-worktree-snapshots.md)
...
- [Agent Tool Call Replay](./agent-tool-call-replay.md)
...
- [Agent Source Grounding](./agent-source-grounding.md)
