...
```sh
agent-diff-budget /tmp/agent-change.diff \
  --max-files 6 \
  --max-total 350 \
...
- Repo / tool / workflow: local `agent-diff-budget` prototype at `/Users/manuelsampedro/Documents/Codex/2026-05-21/agent-diff-budget`.
- Supporting prompt, script, or note: [`./scope-guard-for-agent-diffs.md`](./scope-guard-for-agent-diffs.md), [`./change-risk-matrix-for-agent-diffs.md`](./change-risk-matrix-for-agent-diffs.md), and [`./agent-proof-packet-for-review.md`](./agent-proof-packet-for-review.md).
