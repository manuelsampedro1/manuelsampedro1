...
- Latest lab note: [2026-06-02 - Agent Run Ledger Task Contract Envelope Import](./labs/2026/2026-06-02-agent-run-ledger-task-contract-envelope-import.md)
- Latest recipes:
  - [Task Contract Envelope to Ledger Evidence](./recipes/task-contract-envelope-to-ledger.md)
  - [Task Contract Metadata in Verification Envelopes](./recipes/task-contract-metadata-in-verification-envelopes.md)
  - [Task Contract Evidence to Ledger](./recipes/task-contract-evidence-to-ledger.md)
