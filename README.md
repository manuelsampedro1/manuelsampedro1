...
- Check the final answer for exact evidence before accepting the handoff. See [agent-closeout-check](https://github.com/manuelsampedro1/agent-closeout-check) and [Closeout Evidence Check for Agents](./recipes/closeout-evidence-check-for-agents.md).
...
- Latest lab note: [2026-06-02 - Agent Review Map Public Launch](./labs/2026/2026-06-02-agent-review-map-public-launch.md)
- Latest recipes:
