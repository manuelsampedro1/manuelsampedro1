...
- Keep broad agent diffs below an explicit review budget before they become too large to inspect honestly. See [agent-diff-budget](https://github.com/manuelsampedro1/agent-diff-budget) and [Agent Diff Budget](./recipes/agent-diff-budget.md).
...
- Check the final answer for exact evidence, then compare its claims against the actual diff and command ledger before accepting the handoff. See [agent-closeout-check](https://github.com/manuelsampedro1/agent-closeout-check), [agent-claim-check](https://github.com/manuelsampedro1/agent-claim-check), [Closeout Evidence Check for Agents](./recipes/closeout-evidence-check-for-agents.md), and [Agent Claim Check](./recipes/agent-claim-check.md).
...
- Latest lab note: [2026-06-02 - Agent Claim Check Public Launch](./labs/2026/2026-06-02-agent-claim-check-public-launch.md)
- Latest recipes:
  ...
  - [Structured Task Contract Readiness](./recipes/structured-task-contract-readiness.md)
